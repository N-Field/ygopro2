...
public class gameCard : OCGobject
{
   ...
   // bool picLikeASquare = false;
    ...
    public void animation_show_off(bool summon, bool disabled = false)   
    {
        ...
        {
            if (Program.I().setting.setting.showoff.value == false || File.Exists("Documents/picture/closeup/" + data.Id.ToString() + ".png") == false || (data.Attack < Program.I().setting.atk && data.Level < Program.I().setting.star))
            {
        ...
        {
            if (Program.I().setting.setting.showoffWhenActived.value == false || File.Exists("Documents/picture/closeup/" + data.Id.ToString() + ".png") == false)
            {
